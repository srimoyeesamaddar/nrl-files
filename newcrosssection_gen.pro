;Read old cross-section files, create new base cross-section files and generates new crooss-section data and probability states
...
;___________________________________NEW IONS&ABS CODE_____________________________________________________________
...
;endwhile
;free_lun,lun_fism
;wavelength_low=wave1
;wavelength_high=wave2
;wavelength=(wavelength_low+wavelength_high)/2.
...
;Creating new cross-section output files with given spectral bins
...
;_________________________________________________________________________________________________________________
;___________________________________NEW STATES CODE_____________________________________________________________
